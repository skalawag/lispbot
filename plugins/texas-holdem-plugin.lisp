...
(5am:test betting-round-over?-test
  "actual order of operations: handle > advance > test"
  ;; preflop, two players: call, check
  ...
  ;; preflop, two players: raise, call
  (set-up-game-state '("fyv" "wag"))
  (5am:is (null (betting-round-over?)))
  ...
  ;; preflop, two players: fold
  (set-up-game-state '("fyv" "wag"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'fold)
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, two players: raise, fold
  (set-up-game-state '("fyv" "wag"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, two players: check, check
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, three players: call, call, check
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, three players: raise, call, call
  (set-up-game-state '("fyv" "wag" "gog"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, three players: raise, fold, call
  (set-up-game-state '("fyv" "wag" "gog"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, three players: raise, call, fold
  (set-up-game-state '("fyv" "wag" "gog"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; preflop, three players: raise, raise, call, call
  (set-up-game-state '("fyv" "wag" "gog"))
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, three players: check, check, check
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, three players: raise, call, call
  (set-up-game-state '("fyv" "wag" "gog") "Flop")
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, three players: raise, fold, call
  (set-up-game-state '("fyv" "wag" "gog") "Flop")
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, three players: raise, call, fold
  (set-up-game-state '("fyv" "wag" "gog") "Flop")
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
  ...
  (advance-acting *players*)
  (5am:is (eq t (betting-round-over?)))
  ;; postflop, three players: raise, raise, call, call
  (set-up-game-state '("fyv" "wag" "gog") "Flop")
  (5am:is (null (betting-round-over?)))
  (handle-player-action (get-acting *players*) 'raise 45)
  (advance-acting *players*)
